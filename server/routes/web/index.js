module.exports = app =>{
  ...
  router.get('/heroes/init',async(req,res)=>{
    ...
    for(let cate of data){
      ...
      cate.heros = cate.heros.map(hero=>{
        hero.categories = [category]
        return hero
      })
      await Hero.insertMany(cate.heros)
    }
  ...
  router.get('/heroes/:id',async(req,res)=>{
    const data = await Hero.findById(req.params.id).populate('categories goodItems badItems partners.hero').lean()
    res.send(data)
  })
